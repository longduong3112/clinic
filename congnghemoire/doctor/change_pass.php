...
<div class="container mt-12" style="width:900px; margin-left:20px;">
    <h2 style="margin-left:50px;">Thay đổi mật khẩu</h2>
	<div class="col-5">
		<form action="change_pass.php" method="post" class="mb-2">
			...
			<div class="form-group">
			    <label>Xác nhận mật khẩu:</label><span class="text-danger"><?php echo $error['confirm_new_password'];?></span>
			    <input type="password" class="form-control" name="confirm_new_password" required="required">
			</div>
			<button type="submit" name="changePass" class="btn btn-primary" style="margin-left:120px;">Xác nhận</button>
		</form>
