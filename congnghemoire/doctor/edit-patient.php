...
<div class="row">
<div class="col-sm-12">
<h2 class="mainTitle" style="margin-left:200px;">Thay đổi thông tin bệnh nhân</h2>
</div>
...
<?php } ?>
<button type="submit" name="submit" id="submit" class="btn btn-o btn-danger" style="margin-left:100px;margin-bottom:20px;">
Cập nhật thông tin
</button>
</form>
</div>
