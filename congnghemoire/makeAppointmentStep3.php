...
for ( $day = 1; $day <= $day_count; $day++, $str++) {
    ...
    if($str % 7 == 0 || strtotime($date) < strtotime($today)):
        ...
        $caLamViec = "<br>
        <p class='text-danger font-weight-bolder'>Đóng Cửa</p>";
    else:
        $caLamViec = "<br>
...
?>
    ...
    <div class="container mt-1 mb-3">
        ...
        <table class="table table-bordered" id = "calendar">
            <tr>
                <th style="width= 200px;">Chủ nhật</th>
                <th>Thứ 2</th>
                <th>Thứ 3</th>
                <th>Thứ 4</th>
                <th>Thứ 5</th>
            ...
            <div class="row justify-content-center">
                <div class="col-2 text-left">
                    ...
                    <button type="submit" name="datlich" class="btn btn-danger">Đặt lịch hẹn</button>
                </div>
