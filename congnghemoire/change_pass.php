...
<h3 style="margin-left:80px;">ĐỔI MẬT KHẨU</h3>
<div class="container mt-3" style="width:600px; margin-left:50px;">
	<div class="col-5">
		<form action="change_pass.php" method="post" class="mb-2">
			...
			<button type="submit" name="changePass" class="btn btn-danger" style="margin-left:50px;">Xác nhận</button>
		</form>
